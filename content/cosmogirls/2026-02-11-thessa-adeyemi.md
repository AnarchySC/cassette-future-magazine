...
hobbies:
- Cryptography
- Star maps (hand-drawn)
- Identity hopping
home: Ganymede Agricultural Domes
name: Thessa Adeyemi
occupation: FTL Navigation Specialist
quote: I can plot a course through any nebula in the galaxy, but I still get lost in a cute pilot's eyes every time.
ship_class: Sleeper Coach
ship_name: The Lucky Rose
ship_type: Passenger liner
species: Arachni
title: 'Cosmogirl: Thessa Adeyemi'
title_jp: 今週のコスモガール
turn_ons:
- A good kisser
- Strong and silent types
- A voice that could melt bulkheads
type: cosmogirls
year: 2935
---
...
**The Lucky Rose** - Sleeper Coach (Passenger liner)
