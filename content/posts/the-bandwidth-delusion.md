...
- data-visualization
language_data:
  - name: "Yamato Standard (Japanese)"
    syllables_per_sec: 7.84
    bits_per_syllable: 5.01
    bits_per_sec: 39.27
    innovation_rank: 13
    freedom_score: 86.0
    rd_pct: 3.4
    ...
    trade_openness: 38
    econ_freedom: 70.2
    species: "Human — Yamato heritage"
  - name: "Iberian Spacer Creole (Spanish)"
    syllables_per_sec: 7.82
    bits_per_syllable: 4.98
    bits_per_sec: 38.96
    innovation_rank: 29
    freedom_score: 83.7
    rd_pct: 1.4
    ...
    trade_openness: 110
    econ_freedom: 66.3
    species: "Human — Iberian heritage"
  - name: "Aurean Cant (Basque)"
    syllables_per_sec: 5.22
    bits_per_syllable: 7.21
    bits_per_sec: 37.64
    innovation_rank: 29
    freedom_score: 83.7
    rd_pct: 1.4
    ...
    trade_openness: 110
    econ_freedom: 66.3
    species: "Human — Aurean colony"
  - name: "Romano Belt Dialect (Italian)"
    syllables_per_sec: 6.99
    bits_per_syllable: 5.36
    bits_per_sec: 37.49
    innovation_rank: 28
    freedom_score: 82.8
    rd_pct: 1.4
    ...
    trade_openness: 113
    econ_freedom: 60.9
    species: "Human — Romano heritage"
  - name: "Slavic Frontier Speech (Serbian)"
    syllables_per_sec: 5.19
    bits_per_syllable: 7.14
    bits_per_sec: 37.05
    innovation_rank: 41
    freedom_score: 70.6
    rd_pct: 1.0
    ...
    trade_openness: 128
    econ_freedom: 64.4
    species: "Human — Slavic frontier"
  - name: "Hangul Station Tongue (Korean)"
    syllables_per_sec: 5.21
    bits_per_syllable: 7.08
    bits_per_sec: 36.88
    innovation_rank: 5
    freedom_score: 81.5
    rd_pct: 5.0
    ...
    trade_openness: 85
    econ_freedom: 74.0
    species: "Human — Hangul station"
  - name: "Magyar Deep Colony (Hungarian)"
    syllables_per_sec: 5.59
    bits_per_syllable: 6.44
    bits_per_sec: 36.00
    innovation_rank: 32
    freedom_score: 73.7
    rd_pct: 1.6
    ...
    trade_openness: 150
    econ_freedom: 72.8
    species: "Human — Magyar colony"
  - name: "Turkic Rim Patois (Turkish)"
    syllables_per_sec: 4.70
    bits_per_syllable: 7.58
    bits_per_sec: 35.63
    innovation_rank: 37
    freedom_score: 51.0
    rd_pct: 1.1
    ...
    trade_openness: 65
    econ_freedom: 56.1
    species: "Human — Turkic rim"
  - name: "Catalan Orbital Dialect (Catalan)"
    syllables_per_sec: 6.20
    bits_per_syllable: 5.63
    bits_per_sec: 34.90
    innovation_rank: 29
    freedom_score: 83.7
    rd_pct: 1.4
    ...
    trade_openness: 110
    econ_freedom: 66.3
    species: "Human — Catalan orbital"
  - name: "Francophone Core Standard (French)"
    syllables_per_sec: 6.17
    bits_per_syllable: 5.60
    bits_per_sec: 34.56
    innovation_rank: 11
    freedom_score: 81.8
    rd_pct: 2.2
    ...
    trade_openness: 115
    econ_freedom: 64.4
    species: "Human — Francophone core"
  - name: "Suomi Ice-World Dialect (Finnish)"
    syllables_per_sec: 5.22
    bits_per_syllable: 6.51
    bits_per_sec: 33.99
    innovation_rank: 7
    freedom_score: 88.3
    rd_pct: 3.0
    ...
    trade_openness: 96
    econ_freedom: 77.0
    species: "Human — Suomi ice world"
  - name: "Germanic Hauler Tongue (German)"
    syllables_per_sec: 5.18
    bits_per_syllable: 6.55
    bits_per_sec: 33.93
    innovation_rank: 9
    freedom_score: 86.7
    rd_pct: 3.1
    ...
    trade_openness: 118
    econ_freedom: 71.6
    species: "Human — Germanic hauler"
  - name: "Lusophone Trader Creole (Portuguese)"
    syllables_per_sec: 5.19
    bits_per_syllable: 6.43
    bits_per_sec: 33.37
    innovation_rank: 34
    freedom_score: 86.2
    rd_pct: 1.7
    ...
    trade_openness: 108
    econ_freedom: 70.5
    species: "Human — Lusophone trader"
  - name: "Zhōngwén Authority Standard (Mandarin)"
    syllables_per_sec: 5.18
    bits_per_syllable: 6.41
    bits_per_sec: 33.20
    innovation_rank: 10
    freedom_score: 49.3
    rd_pct: 2.6
    ...
    trade_openness: 37
    econ_freedom: 49.0
    species: "Human — Zhōngwén authority"
  - name: "Yuè Free-Port Cant (Cantonese)"
    syllables_per_sec: 5.49
    bits_per_syllable: 5.72
    bits_per_sec: 31.40
    innovation_rank: 14
    freedom_score: 76.8
    rd_pct: 1.0
    ...
    trade_openness: 310
    econ_freedom: 61.4
    species: "Human — Yuè free-port"
  - name: "Viet Jungle-World Tongue (Vietnamese)"
    syllables_per_sec: 5.22
    bits_per_syllable: 5.97
    bits_per_sec: 31.16
    innovation_rank: 44
    freedom_score: 52.9
    rd_pct: 0.5
    ...
    trade_openness: 165
    econ_freedom: 65.2
    species: "Human — Viet jungle-world"
  - name: "Anglish Common (English)"
    syllables_per_sec: 5.09
    bits_per_syllable: 6.62
    bits_per_sec: 33.71
    innovation_rank: 4
    freedom_score: 87.1
    rd_pct: 3.5
    ...
    trade_openness: 27
    econ_freedom: 70.2
    species: "Human — multi-system lingua franca"
  - name: "Batavian Trade Standard (Dutch)"
    syllables_per_sec: 4.91
    bits_per_syllable: 6.86
    bits_per_sec: 33.68
    innovation_rank: 6
    freedom_score: 88.1
    rd_pct: 2.3
    ...
    trade_openness: 175
    econ_freedom: 78.2
    species: "Human — Batavian trade league"
  - name: "Tai Monsoon Dialect (Thai)"
    syllables_per_sec: 4.43
    bits_per_syllable: 7.35
    bits_per_sec: 32.56
    innovation_rank: 36
    freedom_score: 67.9
    rd_pct: 1.2
    ...
    trade_openness: 120
    econ_freedom: 60.6
    species: "Human — Tai monsoon world"
  - name: "Ursari Deep Speech (Hindi)"
    syllables_per_sec: 5.07
    bits_per_syllable: 6.30
    bits_per_sec: 31.92
    innovation_rank: 46
    freedom_score: 62.6
    rd_pct: 0.7
